					...
					int nr_to_scan)
{
	...
	if(!mutex_trylock(&mstar_cma->cma->mlock))
		goto OUT_NO_LOCK;
...
static const struct proc_ops cmarunlist_proc_fops = {
	.proc_open		= cmarunlist_proc_open,
	.proc_read		= seq_read,
...
static const struct proc_ops cmabitmap_proc_fops = {
	.proc_open		= cmabitmap_proc_open,
	.proc_read		= seq_read,
	.proc_lseek		= seq_lseek,
	.proc_release	= single_release,
};
