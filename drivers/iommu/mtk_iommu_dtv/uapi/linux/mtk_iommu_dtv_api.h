...
#define MAX_DMAHEAP_CACHED_NAME_SIZE		20
#define MAX_DMAHEAP_CACHED_2XIOVA_NAME_SIZE	40
#define MAX_DMAHEAP_UNCACHED_NAME_SIZE		30
#define MAX_DMAHEAP_UNCACHED_2XIOVA_NAME_SIZE	40
...
struct mdiommu_buftag_data {
	unsigned int buf_tag_array[MAX_TAG_NUM];
	unsigned int len_array[MAX_TAG_NUM];
...
#define MDIOMMU_IOC_QUERY_BUFTAG_USAGE	\
		_IOWR(MDIOMMU_IOC_MAGIC, 18, struct mdiommu_buftag_data)
#define MDIOMMU_IOC_QUERY_BUFTAG_ID	\
		_IOWR(MDIOMMU_IOC_MAGIC, 19, struct mdiommu_buftag_data)
#define MDIOMMU_IOC_QUERY_ID\
		_IOWR(MDIOMMU_IOC_MAGIC, 20, struct mdiommu_buftag_data)
#define MDIOMMU_IOC_GET_CARVOUT_SIZE	\
		_IOWR(MDIOMMU_IOC_MAGIC, 21, struct mdiommu_ioc_data)
#define MDIOMMU_IOC_EN_LV2_CARV		\
		_IOWR(MDIOMMU_IOC_MAGIC, 22, struct mdiommu_ioc_data)
#define MDIOMMU_IOC_COLLECTOR_PRIOR	\
		_IOWR(MDIOMMU_IOC_MAGIC, 23, struct mdiommu_ioc_data)
#endif
