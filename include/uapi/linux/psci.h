...
#define PSCI_MSTAR_STR_BOOT		0x000000
#define PSCI_MSTAR_AC_BOOT		0x010000
#define PSCI_MSTAR_DISABLE_FBOOT	0x020000
#define PSCI_MSTAR_BOOT_MODE_MASK       0xff0000
