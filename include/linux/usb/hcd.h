...
#define MS_FLAG_FAST_CONNECT 1<<3
#define MS_FLAG_PMPORT (1<<4)
#define MS_FLAG_VBUS_CTRL_EN (1<<5)
#define MS_FLAG_VBUS_ACTIVE (1<<6)
#define MS_FLAG_OTG_PORT (1<<7)
	...
	struct usb_ppc	ppc;
	struct usb_utmi_param	utmi_param;
#endif /* MP_USB_MSTAR */
