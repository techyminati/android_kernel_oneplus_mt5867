...
#ifdef CONFIG_MP_PCI_PATCH_ADDR_TRANSLATE
	void *va;
	va = dma_alloc_coherent(&hwdev->dev,
...
#ifdef CONFIG_MP_PCI_PATCH_ADDR_TRANSLATE
	dma_addr_t dma_handle;
	dma_handle = dma_map_single(&hwdev->dev, ptr, size, (enum dma_data_direction)direction);
	BA_TO_PA(dma_handle);
	return dma_handle;
#else
...
#ifdef CONFIG_MP_PCI_PATCH_ADDR_TRANSLATE
	dma_addr_t dma_handle;
	dma_handle = dma_map_page(&hwdev->dev, page, offset, size, (enum dma_data_direction)direction);
	BA_TO_PA(dma_handle);
	return dma_handle;
#else
