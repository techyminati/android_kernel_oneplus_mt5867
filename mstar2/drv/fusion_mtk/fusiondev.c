...
static const struct proc_ops fusiondev_stat_proc_fops = {
     .proc_open    = fusiondev_stat_proc_open,
     .proc_read    = seq_read,
                ...
                unsigned int cmd, unsigned long arg)
{
     ...
     switch (_IOC_NR(cmd)) {
        ...
        if (unlocked_copy_from_user
			  ...
			  if (is_compat_task())
			  {
				 send.msg_data = (void *)compat_ptr(send.compat_value);
			  }
		#endif
		#endif
     ...
     switch (_IOC_NR(cmd)) {
          case _IOC_NR(FUSION_CALL_NEW):
			...
			if (unlocked_copy_from_user(&call, (FusionCallNew *) arg, sizeof(call)))
    	        ...
    	        if (is_compat_task())
		 {
		       call.handler = (void *)compat_ptr(call.handler_compat_value);
		       call.ctx = (void *)compat_ptr(call.ctx_compat_value);
	        }
#endif
#endif
          ...
          case _IOC_NR(FUSION_CALL_EXECUTE):
 	        ...
 	        if (is_compat_task())
		 {
		      execute.call_ptr = (void *)compat_ptr(execute.compat_value);
		 }
#endif
#endif              
          ...
          case _IOC_NR(FUSION_CALL_EXECUTE2):
		    ...
		    if (is_compat_task())
		    {
		       execute2.ptr = (void *)compat_ptr(execute2.compat_value);
		    }
#endif
#endif
          ...
          case _IOC_NR(FUSION_CALL_EXECUTE3):
		    ...
		    if (is_compat_task())
		    {
		       execute3.ptr = (void *)compat_ptr(execute3.ptr_compat_value);
			   execute3.ret_ptr = (void *)compat_ptr(execute3.ret_compat_value);
		    }
#endif
#endif
          ...
          case _IOC_NR(FUSION_CALL_RETURN3):
		  	if (unlocked_copy_from_user
        	    ...
        	    if (is_compat_task())
        	    {
        	       call_ret3.ptr = (void *)compat_ptr(call_ret3.compat_value);
        	    }
#endif
#endif            
              ...
              unsigned int cmd, unsigned long arg)
{
     ...
     switch (_IOC_NR(cmd)) {
		  ...
		  if (is_compat_task())
		  {
			 dispatch.msg_data = (const void *)compat_ptr(dispatch.compat_value);
		  }
#endif
#endif
		  ...
		  if (is_compat_task())
		  {
			 callback.call_ptr = (int *)compat_ptr(callback.compat_value);
		  }
#endif
#endif
              ...
              unsigned int cmd, unsigned long arg)
{
     ...
     switch (_IOC_NR(cmd)) {
		 ...
		 if (is_compat_task())
		 {
			pool.addr_base = (int *)compat_ptr(pool.compat_value);
		 }
#endif
#endif            
		 ...
		 if (is_compat_task())
		 {
			attach.addr_base = (int *)compat_ptr(attach.compat_value);
		 }
#endif
#endif
