...
struct tee_shm *tee_shm_alloc_1_0_1(struct tee *tee, size_t size, uint32_t flags)
#else
...
#ifdef CONFIG_TEE_2_4
void tee_shm_free_1_0_1(struct tee_shm *shm)
#else
...
#ifdef CONFIG_TEE_2_4
void tee_shm_put_1_0_1(struct tee_context *ctx, struct tee_shm *shm)
#else
