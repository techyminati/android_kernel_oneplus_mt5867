...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 15, 0)
static struct proc_ops crc_fops = {
	.proc_write   = crc_write,
};
...
static struct proc_ops tz_fops2 = {
	.proc_write   = tz_write_name,
};

static struct proc_ops tz_fops3 = {
	.proc_write   = tz_write_file_name,
};

static struct proc_ops tz_fops4 = {
	.proc_write   = tz_write_nagra_warmboot,
};
...
static struct proc_ops tz_fops_misc = {
#ifdef CONFIG_COMPAT
	.proc_compat_ioctl = tee_xtest_ioctl,
#endif
	.proc_ioctl = tee_xtest_ioctl,
};
#else
