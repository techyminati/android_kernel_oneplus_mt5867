...
# endif
	...
	entry = proc_create("irq", 0666, desc->dir, (const struct proc_ops *)&irq_proc_file_operations);
#else
	entry = proc_create("irq", 0600, desc->dir, (const struct proc_ops *)&irq_proc_file_operations);
#endif
	if (entry)
