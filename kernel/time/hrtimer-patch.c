...
//---------------------------------------------------------------
const struct proc_ops ns_bound_proc_fops = {
    .proc_open           = ns_bound_open,
    .proc_read           = ns_bound_read,
    .proc_release        = ns_bound_release,
    .proc_write          = ns_bound_proc_write,
};

const struct proc_ops ns_bound_toggle_proc_fops = {
    .proc_open           = ns_toggle_open,
    .proc_read           = ns_toggle_read,
    .proc_release        = ns_toggle_release,
    .proc_write          = ns_toggle_proc_write,
};

const struct proc_ops exc_pname_proc_fops = {
    .proc_open           = exc_pname_open,
    .proc_read           = exc_pname_read,
    .proc_release        = exc_pname_release,
    .proc_write          = exc_pname_proc_write,
};

const struct proc_ops ns_exc_load_bound_proc_fops = {
    .proc_open           = ns_exc_load_bound_open,
    .proc_read           = ns_exc_load_bound_read,
    .proc_release        = ns_exc_load_bound_release,
    .proc_write          = ns_exc_load_bound_proc_write,
};



const struct proc_ops exc_pname_proc_fops2 = {
    .proc_open           = exc_pname_open2,
    .proc_read           = exc_pname_read2,
    .proc_release        = exc_pname_release2,
    .proc_write          = exc_pname_proc_write2,
};

const struct proc_ops ns_exc_load_bound_proc_fops2 = {
    .proc_open           = ns_exc_load_bound_open2,
    .proc_read           = ns_exc_load_bound_read2,
    .proc_release        = ns_exc_load_bound_release2,
    .proc_write          = ns_exc_load_bound_proc_write2,
};


const struct proc_ops blacklisted_pname_proc_fops = {
    .proc_open           = blacklisted_pname_open,
    .proc_read           = blacklisted_pname_read,
    .proc_release        = blacklisted_pname_release,
    .proc_write          = blacklisted_pname_proc_write,
};


const struct proc_ops blacklisted_pname_proc_fops2 = {
    .proc_open           = blacklisted_pname_open2,
    .proc_read           = blacklisted_pname_read2,
    .proc_release        = blacklisted_pname_release2,
    .proc_write          = blacklisted_pname_proc_write2,
};



const struct proc_ops ns_low_load_bound_proc_fops = {
    .proc_open           = ns_low_load_bound_open,
    .proc_read           = ns_low_load_bound_read,
    .proc_release        = ns_low_load_bound_release,
    .proc_write          = ns_low_load_bound_proc_write,
};


const struct proc_ops ns_low_load_bound2_proc_fops = {
    .proc_open           = ns_low_load_bound2_open,
    .proc_read           = ns_low_load_bound2_read,
    .proc_release        = ns_low_load_bound2_release,
    .proc_write          = ns_low_load_bound2_proc_write,
};
